...
namespace Project1HostApp
{
    public partial class frmDataloggerSettings : Form
    {
        ...
        private void btnSetValues_Click(object sender, EventArgs e)
        {
            ...
            Answer[0] = (byte)dtpDate.Value.Day;
            Answer[1] = (byte)dtpDate.Value.Month; ;
            Answer[2] = (byte)((dtpDate.Value.Year < 2000) ? 0 : (dtpDate.Value.Year - 2000));
            Answer[3] = (byte)dtpTime.Value.Hour;
            Answer[4] = (byte)dtpTime.Value.Minute;
            Answer[5] = (byte)dtpTime.Value.Second;
            LogIntervall = ((int)nudLogInterval.Value * 2);
            Answer[6] = (byte)LogIntervall;
            Answer[7] = (byte)(LogIntervall >> 8);
            //Answer[6] = (byte)(nudLogInterval.Value * 2);
            ...
            Answer[41] = (byte)daysleft;
            Answer[42] = (byte)(daysleft>>8);
            ...
            try
            {
                ...
                try
                {
                    dtpDate.Value = new DateTime(
                         (2000 + Response[2]), Response[1], Response[0]);
        ...
        private void dGVFiles_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            if (cBCurve0.Checked)
            {
                ...
                curve0.Line.Width = 1.8F;
                curve0.Line.IsSmooth = false;
                curve0.Label.Text = txtlocation1.Text + " Temperature";
            ...
            if (cBCurve1.Checked)
            {
                ...
                curve1.Label.Text = txtlocation1.Text + " Humidity";
            ...
            if (cBCurve2.Checked)
            {
                ...
                curve2.Label.Text = txtlocation2.Text;
            ...
            if (cBCurve3.Checked)
            {
                ...
                curve3.Label.Text = txtlocation3.Text;
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                LineItem curve0 = zedGraphControl1.GraphPane.CurveList[0] as LineItem;

                // Get the PointPairList
                IPointListEdit list1 = curve0.Points as IPointListEdit;

                //list.Add(itick, fmesswert1);
                list1.Add((double)new XDate(DateTime.Now), Response[11]);
                ...
                //list1.Add(itick, fmesswert2);
                list2.Add((double)new XDate(DateTime.Now), Response[12]);

                curve1.IsY2Axis = true;
                curve0.Label.Text = "Temperature";
                curve1.Label.Text = "Humidity";
        ...
        {
            if (cBTimer.Checked) timerRead.Enabled = true;
            else timerRead.Enabled = false;
        }
